...
## 七、阶段索引（详见 `0{2..12}-phase{2..12}.md` 分阶段施工文档）
...
- `01-phase0.md`（P0 脚手架）、`01-phase1.md`（P1 Design System）
- `02-phase2.md`（P2 App Shell）、`03-phase3.md`（P3 书库）、`04-phase4.md`（P4 书籍详情）
- `05-phase5.md`（P5 首页）、`06-phase6.md`（P6 搜索+筛选）、`07-phase7.md`（P7 书库导航）
- `08-phase8.md`（P8 批量）、`09-phase9.md`（P9 认证+管理后台）、`10-phase10.md`（P10 自研页）
- `11-phase11.md`（P11 无障碍+性能审计）、`12-phase12.md`（P12 最终验收+上线）
- 每阶段含：目标 / 影响文件 / 后端改动 / 实施要点 / 回测方法 / 推进标准 / 下一步门禁
